...
//        ));
        ...
        objects2.add(new Sphere(
                ...
                new Vector4f(246/255f,172/255f,0.0f,1.0f),
                Arrays.asList(0.0f,0.0f,0.0f),
                0.125f,
                0.125f,
                0.125f,
...
//                objects.get(objects.size()-1).BoundingRectMax();
//                checkCollisionFinal();
...
//                checkCollisionFinal();
        ...
        if (window.isKeyPressed(GLFW_KEY_A)) {
            ...
            if(!disable && !checkCollisionFinal()){
                ...
                objects.get(objects.size()-1).rotateObject((float) Math.toRadians(0.2f),0f,1f,0f);
                objects.get(objects.size()-1).translateObject((target.x + xnow) * 1, (target.y + ynow) * 1, (target.z + znow) * 1);
            } else if (checkCollisionFinal()) {
                float xnow = (float) ((sub.x * Math.cos(Math.toRadians(0f))) + (sub.z * Math.sin(Math.toRadians(0f))));
                float ynow = sub.y;
...
//                System.out.println(tmp);
                ...
                camera.setRotation((float)Math.toRadians(preRoamDirX),(float)Math.toRadians(-90.0f));
                disable = false;
            }
        }
    }
    ...
    public void loop(){
        while (window.isOpen()) {
            ...
            for(Object object:objects){
                object.draw(camera,projection,3,new Vector3f(0,0,0));
            }
